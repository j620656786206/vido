...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://192.168.50.52:8088/settings/qbittorrent and verify the qBittorrent connection settings form and the Test Connection / Save actions are present.
