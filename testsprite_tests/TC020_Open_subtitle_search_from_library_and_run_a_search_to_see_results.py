...
async def run_test():
    ...
    try:
        ...
        # -> Open the media item details (click the DASS-880.mp4 card) to access subtitle search actions.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=OpenSubtitles · English · SRT').first).to_be_visible(timeout=3000)
