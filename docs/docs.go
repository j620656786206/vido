            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tmdb.SearchResultMovies"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tmdb.MovieDetails"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tmdb.SearchResultTVShows"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tmdb.TVShowDetails"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "tmdb.Creator": {
            ...
            "properties": {
                "credit_id": {
                    "type": "string",
                    "example": "52542286760ee313280006ce"
                },
                "gender": {
                    "type": "integer",
                    "example": 2
        ...
        "tmdb.Season": {
            ...
            "properties": {
                ...
                "overview": {
                    "type": "string",
                    "example": "High school chemistry teacher Walter White's life is suddenly transformed by a dire medical diagnosis."
                },
                "poster_path": {
                    "type": "string",
        ...
        "tmdb.TVShow": {
            ...
            "properties": {
                ...
                "overview": {
                    "type": "string",
                    "example": "When Walter White, a New Mexico chemistry teacher, is diagnosed with Stage III cancer and given a prognosis of only two years left to live."
                },
                "popularity": {
                    "type": "number",
                    "example": 369.594
