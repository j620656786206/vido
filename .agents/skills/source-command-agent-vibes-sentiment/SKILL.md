...
Migrated from source command `agent-vibes-sentiment` into a Codex skill. Invoke it as `$source-command-agent-vibes-sentiment` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
