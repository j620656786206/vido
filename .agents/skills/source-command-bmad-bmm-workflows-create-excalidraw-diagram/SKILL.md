...
Use this skill when the user asks to run the migrated source command `bmad-bmm-workflows-create-excalidraw-diagram`.
...
Migrated from source command `bmad-bmm-workflows-create-excalidraw-diagram` into a Codex skill. Invoke it as `$source-command-bmad-bmm-workflows-create-excalidraw-diagram` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
