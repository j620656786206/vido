---
name: "source-command-agent-vibes-bmad"
description: "Run the migrated source command `agent-vibes-bmad`."
---

# source-command-agent-vibes-bmad

Use this skill when the user asks to run the migrated source command `agent-vibes-bmad`.
...
Migrated from source command `agent-vibes-bmad` into a Codex skill. Invoke it as `$source-command-agent-vibes-bmad` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
