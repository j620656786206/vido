---
name: "source-command-bmad-bmm-workflows-testarch-test-design"
...
# source-command-bmad-bmm-workflows-testarch-test-design

Use this skill when the user asks to run the migrated source command `bmad-bmm-workflows-testarch-test-design`.
...
Migrated from source command `bmad-bmm-workflows-testarch-test-design` into a Codex skill. Invoke it as `$source-command-bmad-bmm-workflows-testarch-test-design` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
