...
type MovieRepositoryInterface interface {
	...
	// UpdateSubtitleGenerationStatus writes ONLY status/path/language for an
	// item whose subtitle was GENERATED by the M1 pipeline, never searched:
	// `subtitle_search_score` and `subtitle_last_searched` must stay untouched
	// (sub-1-5b AC #6.3; wired by sub-1-6, closing
...
type EpisodeRepositoryInterface interface {
	...
	// FindMissingZhHantSubtitle retrieves episodes with a media file but no
	// zh-Hant subtitle — the episode-grain twin of the movie enumeration.
	// Needed by: Story sub-1-6 AC #11 (scanner auto-enqueue). 9R-16 shipped
