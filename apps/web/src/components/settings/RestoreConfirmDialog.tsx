    ...
    >
      <div className="mx-4 w-full max-w-md rounded-xl border border-slate-700 bg-slate-800 p-6 shadow-2xl">
        <div className="mb-4 flex items-center gap-3">
          ...
          <h3 className="text-lg font-semibold text-slate-200">確認還原</h3>
        </div>
        ...
        <div className="flex justify-end gap-3">
          <button
            ...
            className="rounded-lg border border-slate-600 px-4 py-2 text-sm text-slate-300 transition-colors hover:bg-slate-700 disabled:opacity-50"
