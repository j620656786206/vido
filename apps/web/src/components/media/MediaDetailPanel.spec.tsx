...
const mockTVShowDetails: TVShowDetails = {
  ...
  created_by: [
    { id: 1, name: '創作者一', profile_path: null },
  ],
  networks: [
...
const mockCredits: Credits = {
  ...
  crew: [
    { id: 3, name: '導演名', job: 'Director', department: 'Directing', profile_path: '/director.jpg' },
  ],
};
...
describe('MediaDetailPanel', () => {
  describe('Loading state', () => {
    it('should render skeleton when loading', () => {
      render(
        <MediaDetailPanel type="movie" details={null} isLoading={true} />
      );
    ...
    it('should render skeleton when details is null', () => {
      render(
        <MediaDetailPanel type="movie" details={null} isLoading={false} />
      );
      expect(screen.getByTestId('media-detail-skeleton')).toBeInTheDocument();
    });
  });
  ...
  describe('Movie details', () => {
    it('should render movie title', () => {
      render(
        <MediaDetailPanel type="movie" details={mockMovieDetails} />
      );
    ...
    it('should not render original title when same as title', () => {
      ...
      render(
        <MediaDetailPanel type="movie" details={movieWithSameTitle} />
      );
    ...
    it('should render overview', () => {
      ...
      expect(screen.getByTestId('detail-overview')).toHaveTextContent('這是一部測試電影的劇情簡介。');
    });

    it('should render fallback text when overview is empty', () => {
      const movieNoOverview = { ...mockMovieDetails, overview: '' };
      render(
        <MediaDetailPanel type="movie" details={movieNoOverview} />
      );
    ...
    it('should render director when credits provided', () => {
      render(
        <MediaDetailPanel type="movie" details={mockMovieDetails} credits={mockCredits} />
      );
  ...
  describe('TV Show details', () => {
    it('should render TV show name', () => {
      render(
        <MediaDetailPanel type="tv" details={mockTVShowDetails} />
      );
  ...
  describe('Images', () => {
    ...
    it('should not render poster when path is null', () => {
      ...
      render(
        <MediaDetailPanel type="movie" details={movieNoPoster} />
      );
