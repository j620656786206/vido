...
// (bugfix-10-7 AC #1) — disabled (id=0) until hover. Stub them so the rendered cards don't need a
// QueryClientProvider ancestor here. Return shape is typed (PosterCard only reads `.data?.runtime`
// / `.data?.numberOf*`) — ZERO `as any`; the full UseQueryResult typing is exercised in
// PosterCard.spec.tsx, which is the spec that actually drives these hooks.
