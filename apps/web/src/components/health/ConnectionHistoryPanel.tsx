// Design ref: ux-design.pen — no current screen frame; Story 4.6 connection-history side panel postdates the .pen design (C4-D shows only the qBT connection form)
/**
