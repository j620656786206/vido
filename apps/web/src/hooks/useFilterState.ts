...
export function useFilterState(): UseFilterStateResult {
  ...
  // ux3-cutover-3: replace is unconditional now — intermediate filter toggles
  // never push half-built combos onto the browser stack (ux3-3-2 AC #5; the
  // legacy push-semantics consumer is gone).
