...
export function useDownloads(
  ...
  // ux3-cutover-3: the 5s list poll is fully retired — the lazy useDownloadProgress
  // SSE hook is the freshness source (ux3-4-3b AC4); the legacy 5s-poll consumer is gone.
